...
PGOBENCH = ./$(EXE) bench 16 1 $(PTIME) default time

### Object files
OBJS = benchmark.o bitbase.o bitboard.o endgame.o main.o \
	misc.o movegen.o movepick.o pawns.o position.o \
	k_pawns.o k_material.o k_psqt.o k_evaluate.o \
	search.o thread.o timeman.o tt.o uci.o ucioption.o syzygy/tbprobe.o \
    egtb_syzygyprobe.o egtb_nalimov.o egtb_nalimovprobe.o
